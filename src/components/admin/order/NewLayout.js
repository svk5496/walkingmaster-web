...
function OrderNewLayout() {
  ...
  const { data } = useQuery(SEE_NEW_ORDER_QUERY, {
    variables: {
    ...
    <>
      <Layer>
        ...
        <Container>
          ...
          {/* 컨텐트 시작 */}
          <OrderNewList data={data}></OrderNewList>
        </Container>
      </Layer>
    </>
  );
